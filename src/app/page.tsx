...
import { ShoppingCart, LayoutDashboard, Utensils, Package, Store, BarChart3, Settings, Users, LogOut, Lock, Globe, Coffee, Clock, TrendingUp } from 'lucide-react';
    ...
    <div className="min-h-screen">
            ...
            <div className="flex items-center gap-3">
              {user.branchId && (
                <div className="hidden md:flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300">
                  ...
                  <span>{t('pos.branch')}: {user.branchId}</span>
                </div>
              )}
      ...
      <main className="flex-1 container mx-auto px-4 py-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-8 lg:w-auto lg:inline-grid bg-white/60 backdrop-blur-md rounded-xl shadow-xl border border-slate-200/200 p-1">
